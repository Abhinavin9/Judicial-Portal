    ...
    <div className="space-y-8 animate-fade-in relative z-10">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 mt-2 font-medium italic">Welcome back, {user?.name} <span className="lowercase">({user?.role?.replace('_', ' ')})</span></p>
        </div>
              ...
              <div className="flex items-center gap-6">
                ...
                <div>
                  <p className="text-xl font-black text-gray-900 dark:text-white tracking-tight">
                    {user?.name} <span className="text-xs text-primary-500 font-bold lowercase tracking-normal">({user?.role?.replace('_', ' ')})</span>
                  </p>
                </div>
              </div>
            </div>
